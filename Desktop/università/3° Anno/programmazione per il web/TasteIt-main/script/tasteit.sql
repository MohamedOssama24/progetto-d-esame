...
INSERT INTO `customers`(`name`, `surname`, `email`, `password`, `favId`, `cartId`, `imagePath`) VALUES ('Marco ','Rossi','mrossi@gmail.com','$2y$10$TXeIAq0qe1Y64.IZ1Mcxqued1I0pliDMZShtsMk3kwoW46Oscui8u',1,1, '/src/assets/images/marco.jpg');
INSERT INTO `customers`(`name`, `surname`, `email`, `password`, `favId`, `cartId`, `imagePath`) VALUES ('Antonio','Rosa','sandro@gmail.com','$2y$10$14/Tfqh4PA3NOKUVRtppf.DbkI1MQqr1seHiNLYZZ1CRLJ8ZT/VqW',2,2, '/src/assets/images/anto.jpg');
INSERT INTO `customers`(`name`, `surname`, `email`, `password`, `favId`, `cartId`, `imagePath`) VALUES ('Mohamed','Bianchi','mic@gmail.com','$2y$10$NnS.6A9FCprxEYcHXUxZIOAUAK/cQYm894UMj6FpFWu8A6Jm/6N1e',3,3, '/src/assets/images/mohamed.jpg');
insert into `customers`(`name`, `surname`, `email`, `password`, `favId`, `cartId`, `imagePath`) VALUES ('Silvieri','Barbieri','alice.barbieri@gmail.com','$2y$10$V/ftzhOF/kRv9sTGMxFxg.iG.tD5lnrQlAwtEGkALBU31lYXcGioi',4,4, '/src/assets/images/poses-para-selfie-12.jpg');
insert into `customers`(`name`, `surname`, `email`, `password`, `favId`, `cartId`, `imagePath`) VALUES ('Devastatore','Martini','andreamartini89@gmail.com','$2y$10$eCrddjc9.1LBoNxhqLW6k.4vg0cztSYTr0PQR5QF5f222ESG4ADdi',5,5, '/src/assets/images/selfie-google-e1554862824540.jpg');
insert into `customers`(`name`, `surname`, `email`, `password`, `favId`, `cartId`, `imagePath`) VALUES ('Ossama','Battaglia','fbattaglia@gmail.com','$2y$10$kzvQE2eB4GCawOWqQ.GaFeHIVSewUh9k3BGAm5svVnDXsOOLWkmpG',6,6, '/src/assets/images/MCKENZIE.jpg');
INSERT INTO `shippingAddresses`(`cap`, `city`, `street`, `homeNumber`, `customerId`) VALUES (1234,'Pescara','Via Dante',2,null);
...
insert into coupons (`id`, `priceCut`, `expirationDate`, `customerId`) values ('C614c7de6d8a19', 30, '2022-12-07', 1);
INSERT INTO `coupons`(`id`, `priceCut`, `expirationDate`, `customerId`) VALUES ('C614c7de6d8345', 20,'2022-09-13',1);
INSERT INTO `coupons`(`id`, `priceCut`, `expirationDate`, `customerId`) VALUES ('C614c7de6d8790', 20,'2022-11-13',2);
INSERT INTO `coupons`(`id`, `priceCut`, `expirationDate`, `customerId`) VALUES ('C614c7de6d8r61', 15,'2022-08-09',3);
...
INSERT INTO `orders`(`creationDate`, `total`, `arrivalTime`, `couponId`, `customerId`, `paymentId`,`orderState`, `addressId`, `cardId`) VALUES ('2022-07-1',12,NULL,'C614c7de6d8a19',1,1,'Completed',1,null);
INSERT INTO `orders`(`creationDate`, `total`, `arrivalTime`, `couponId`, `customerId`, `paymentId`, `orderState`, `addressId`, `cardId`) VALUES ('2022-07-1',25,NULL,'C614c7de6d8a19',1,1,'Denied',2,null);
INSERT INTO `orders`(`creationDate`, `total`, `arrivalTime`, `couponId`, `customerId`, `paymentId`, `orderState`, `addressId`, `cardId`) VALUES ('2022-06-1',19.2,'20:00:00','C614c7de6d8345',2,1,'Completed',3,2);
INSERT INTO `categories`(`restaurantId`, `categoryName`, `imagePath`) VALUES (1,'Pasta','/src/assets/images/m.jpg');
INSERT INTO `categories`(`restaurantId`, `categoryName`, `imagePath`) VALUES (1,'Pesce','/src/assets/images/p.jpg');
INSERT INTO `categories`(`restaurantId`, `categoryName`, `imagePath`) VALUES (1,'Pizza','/src/assets/images/margherita.jpg');
INSERT INTO `categories`(`restaurantId`, `categoryName`, `imagePath`) VALUES (1,'Vino','/src/assets/images/v.jpg');
INSERT INTO `categories`(`restaurantId`, `categoryName`, `imagePath`) VALUES (1,'Carne','/src/assets/images/c.jpg');
INSERT INTO `products`(`name`, `description`, `price`, `categoryId`, `imagePath`, `timesOrdered`) VALUES ('aragosta grigliata','Fresca',8,2,'/src/assets/images/aragosta-grigia.jpg', 80);
INSERT INTO `products`(`name`, `description`, `price`, `categoryId`, `imagePath`, `timesOrdered`) VALUES ('Salmone alla pizzaiola','Filetto di salmone cotti in padella con pomodori pelati',12,2,'/src/assets/images/Salmone-alla-pizzaiola.jpg', 70);
INSERT INTO `products`(`name`, `description`, `price`, `categoryId`, `imagePath`, `timesOrdered`) VALUES ('Insalata di tonno fresco','Filetto di tonno fresco tagliato in cubetti e scottato in padella, accompagnato da cipolla rossa, pomodirini rossi e gialli, cuore di lattuga, olio extravergine di oliva, sale e pepe',6,2,'/src/assets/images/Insalata-di-tonno-fresco.jpg', 10);
INSERT INTO products(name, description, price, categoryId, imagePath, timesOrdered) VALUES ('Margherita','Mozzarella fresca, pomodoro e una foglia di basilico.',6,3,'/src/assets/images/pizza-margherita.jpg', 10);
INSERT INTO products(name, description, price, categoryId, imagePath, timesOrdered) VALUES ('Capricciosa','Mozzarella fresca, pomodoro, olive, prosciutto cotto/crudo, carciofini.',8,3,'/src/assets/images/pizza-capricciosa.jpg', 40);
INSERT INTO products(name, description, price, categoryId, imagePath, timesOrdered) VALUES ('SkreWBall','Vino rosso rubino profondo dal gusto pieno e rustico, con un aroma di frutta rossa matura.',24,4,'/src/assets/images/prod-9.jpg', 50);
...
INSERT INTO products(name, description, price, categoryId, imagePath, timesOrdered) VALUES ('Arrabbiata','Pasta fresca con pomodoro, prezzemolo, aglio e peperoncino',8,1,'/src/assets/images/Arrabbiata-in-pan-1.jpg', 140);
INSERT INTO products(name, description, price, categoryId, imagePath, timesOrdered) VALUES ('Cacio e pepe','Pasta fresca con pecorino romano stagionatura media e pepe nero',9,1,'/src/assets/images/ricetta-pasta-cacio-e-pepe.jpg', 180);
INSERT INTO products(name, description, price, categoryId, imagePath, timesOrdered) VALUES ('Amatriciana','Pasta fresca con pomodoro, pecorino romano stagionatura media e guanciale',9,1,'/src/assets/images/bucatini-allamatriciana2.jpg', 150);
...
INSERT INTO `products`(`name`, `description`, `price`, `categoryId`, `imagePath`, `timesOrdered`) VALUES ('Tagliata di Angus','Tagliata di manzo con rucola e aceto balsamico',30,5,'/src/assets/images/Angus_Cotto_LOW.jpg', 200);
INSERT INTO products(name, description, price, categoryId, imagePath, timesOrdered) VALUES ('Tagliata di manzo','Tagliata di manzo con rucola e aceto balsamico',30,5,'/src/assets/images/tagliata_di_manzo.jpg', 200);
...
INSERT INTO `reviews`(`stars`, `comment`, `customerId`, `productId`) VALUES ('5','Ottima qualità, rapido',3,2);
INSERT INTO `reviews`(`stars`, `comment`, `customerId`, `productId`) VALUES ('4','é da provare assolutamente ',1,5);
...
INSERT INTO `reviews`(`stars`, `comment`, `customerId`, `productId`) VALUES ('5','ci siamo trovati bene ',3,12);
...
INSERT INTO `reviews`(`stars`, `comment`, `customerId`, `productId`) VALUES ('4','Consiglio a tutti di provarlo',3,8);
